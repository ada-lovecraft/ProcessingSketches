...
void drawTitleTabs() {
  ...
  //size based on the hieght of the tabs by 
  //checking the height of the first (all images are the same height)
  ...
  for (int col = 0; col < columnCount; col++) {
    ...
    PImage tabImage = (col == currentColumn) ? tabImageHighlight[col] : tabImageNormal[col];
